        ...
        {modules.map((mod, mi) => (
          <div key={mod.id} className="card overflow-hidden">
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b"
              style={{ borderColor: "var(--border)", background: "var(--card-secondary)" }}>
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={() => handleDeleteModule(mod.id)}
                  className="text-xs px-2 py-1.5 rounded-lg" style={{ color: "var(--danger)" }}>
                  Delete
                </button>
              </div>
            </div>
            ...
            {mod.lessons.length > 0 ? (
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      {lesson.youtube_video_id && (
                        <span className="text-xs px-2 py-0.5 rounded-full flex-shrink-0"
                          style={{ background: "#fef2f2", color: "#dc2626" }}>▶ Video</span>
                      )}
                    </div>
              ...
              <div className="px-5 py-4 text-sm" style={{ color: "var(--foreground-muted)" }}>
